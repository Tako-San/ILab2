...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::vector<int>>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::vector<std::vector<int>>>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
