...
#line 127 "numgrammar.tab.cc"
    ...
    , value ()
  {
    switch (this->type_get ())
    {
      ...
      case 14: // eqlist
        value.move< std::vector<std::vector<std::vector<int>>> > (std::move (that.value));
        break;
    ...
    , value ()
  {
    switch (this->type_get ())
    {
      ...
      case 14: // eqlist
        value.copy< std::vector<std::vector<std::vector<int>>> > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->type_get ())
    {
      ...
      case 14: // eqlist
        value.move< std::vector<std::vector<std::vector<int>>> > (YY_MOVE (s.value));
        break;
    ...
    : super_type (YY_MOVE (that.state))
  {
    switch (that.type_get ())
    {
      ...
      case 14: // eqlist
        value.YY_MOVE_OR_COPY< std::vector<std::vector<std::vector<int>>> > (YY_MOVE (that.value));
        break;
    ...
    : super_type (s)
  {
    switch (that.type_get ())
    {
      ...
      case 14: // eqlist
        value.move< std::vector<std::vector<std::vector<int>>> > (YY_MOVE (that.value));
        break;
  ...
  yyreduce:
      ...
      switch (yyr1_[yyn])
    {
      ...
      case 14: // eqlist
        yylhs.value.emplace< std::vector<std::vector<std::vector<int>>> > ();
        break;
...
#line 736 "numgrammar.tab.cc"
    break;

  case 6:
#line 58 "numgrammar.y"
                              { yylhs.value.as < std::vector<int> > ().push_back(yystack_[0].value.as < int > ()); }
#line 742 "numgrammar.tab.cc"
    break;

  case 7:
#line 59 "numgrammar.y"
                              { 
...
#line 751 "numgrammar.tab.cc"
    break;

  case 8:
#line 63 "numgrammar.y"
                              { 
                                yylhs.value.as < std::vector<int> > () = yystack_[2].value.as < std::vector<int> > (); 
...
#line 762 "numgrammar.tab.cc"
    break;


#line 766 "numgrammar.tab.cc"
...
#line 1102 "numgrammar.tab.cc"

#line 71 "numgrammar.y"
