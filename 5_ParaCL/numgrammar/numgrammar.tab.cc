...
#line 643 "numgrammar.tab.cc"
    break;

  case 6:
#line 61 "numgrammar.y"
                              { yylhs.value.as < int > () = yystack_[0].value.as < int > (); }
#line 649 "numgrammar.tab.cc"
    break;

  case 7:
#line 62 "numgrammar.y"
                              { yylhs.value.as < int > () = yystack_[2].value.as < int > () + yystack_[0].value.as < int > (); }
#line 655 "numgrammar.tab.cc"
    break;

  case 8:
#line 63 "numgrammar.y"
                              { yylhs.value.as < int > () = yystack_[2].value.as < int > () - yystack_[0].value.as < int > (); }
#line 661 "numgrammar.tab.cc"
    break;


#line 665 "numgrammar.tab.cc"
...
#line 1001 "numgrammar.tab.cc"

#line 66 "numgrammar.y"
